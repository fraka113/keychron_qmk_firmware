...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_66(
        ...
        KC_LCTL,  KC_LOPTN, KC_LCMMD, MO(KEY_FN), KC_SPC,                       KC_SPC,             MO(MAC_FN),MO(COM_FN),KC_LEFT, KC_DOWN,  KC_RGHT),
    ...
    [MAC_FN] = LAYOUT_ansi_66(
	    RGB_TOG,  KC_BRID,  KC_BRIU,  KC_MCTRL, KC_LNPAD, RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  _______,  KC_EQL,   KC_PLUS,  _______,
    ...
    [WIN_FN] = LAYOUT_ansi_66(
	    RGB_TOG,  KC_BRID,  KC_BRIU,  KC_TASK,  KC_FILE,  RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  _______,  KC_EQL,   KC_PLUS,  _______,
        KC_GRV,   BT_HST1,  BT_HST2,  BT_HST3,  P2P4G,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,  RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  NK_TOGG,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,                      _______,            _______,  _______,  _______,  _______,  _______),
    ...
    [KEY_FN] = LAYOUT_ansi_66(
        _______,      _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        RCMD(KC_GRV), _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,      _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,      _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,      _______,  _______,  _______,  _______,                      _______,            _______,  _______,  _______,  _______,  _______)
};
...
const uint16_t PROGMEM encoder_map[][2][2] = {
    ...
    [KEY_FN]   = {ENCODER_CCW_CW(_______, _______),ENCODER_CCW_CW(_______, _______)},
};
...
// Add support for Norwegian charachters using combo keys
const uint16_t PROGMEM combo_ae[] = {KC_I, KC_P, COMBO_END}; // æ
const uint16_t PROGMEM combo_oe[] = {KC_I, KC_O, COMBO_END}; // ø
const uint16_t PROGMEM combo_aa[] = {KC_O, KC_P, COMBO_END}; // å
...
combo_t key_combos_mac[] = {
    COMBO(combo_ae, RALT(KC_QUOT)),
    COMBO(combo_oe, RALT(KC_O)), 
    COMBO(combo_aa, RALT(KC_A)), 
};
...
void set_combos_mac(void){
    memcpy(key_combos, key_combos_mac, sizeof key_combos);
}
