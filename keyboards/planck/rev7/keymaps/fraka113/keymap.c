...
enum planck_layers { _QWERTY, _QWERTYMAC, _LOWER, _RAISE, _ADJUST };
...
#define QWERTY_MAC PDF(_QWERTYMAC)
...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, BACKLIT, KC_LALT, KC_LGUI, LOWER,   KC_RSFT, KC_SPC,  RAISE,   KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT
),
 ...
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTYMAC] = LAYOUT_planck_grid(
    KC_TAB,  KC_Q,    KC_W,     KC_E,     KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
    KC_ESC,  KC_A,    KC_S,     KC_D,     KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
    KC_LSFT, KC_Z,    KC_X,     KC_C,     KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   KC_ENT,
    KC_LCTL, BACKLIT, KC_LGUI, KC_LALT,   LOWER,   KC_RSFT, KC_SPC,  RAISE,   KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT
),
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, EE_CLR,  MU_NEXT, AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  QWERTY_MAC, _______, _______, _______,
